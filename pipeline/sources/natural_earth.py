...
DATASETS = [
    ...
    dict(
        layer="admin_0_countries_lakes",
        category="cultural",
        scales=ALL_SCALES,
        admin_level=0,
        fields=None,
        name="Countries (No Boundary Lakes)",
        description="World country boundaries with boundary lakes (e.g. the Great Lakes, Caspian Sea) excluded from the polygons.",
        tags=["countries", "world", "admin-0", "boundaries", "no-lakes"],
    ),
    dict(
    ...
    dict(
        layer="admin_1_states_provinces_lakes",
        category="cultural",
        scales=ALL_SCALES,
        admin_level=1,
        fields=None,
        name="States & Provinces (No Boundary Lakes)",
        description="First-level administrative divisions worldwide with large lakes excluded from the polygons.",
        tags=["states", "provinces", "world", "admin-1", "boundaries", "no-lakes"],
    ),
    dict(
    ...
    dict(
        ...
        fields=None,
        name="Graticules 1°",
        full_name="Graticules 1°",
        description="Reference grid lines at 1-degree intervals.",
        tags=["reference", "geographic", "graticules", "world"],
    ),
    dict(
        layer="graticules_5",
        category="physical",
        ...
        fields=None,
        name="Graticules 5°",
        full_name="Graticules 5°",
        description="Reference grid lines at 5-degree intervals.",
        tags=["reference", "geographic", "graticules", "world"],
    ),
    dict(
        layer="graticules_10",
        ...
        fields=None,
        name="Graticules 10°",
        full_name="Graticules 10°",
        description="Reference grid lines at 10-degree intervals.",
        tags=["reference", "geographic", "graticules", "world"],
    ),
    dict(
        layer="graticules_15",
        ...
        fields=None,
        name="Graticules 15°",
        full_name="Graticules 15°",
        description="Reference grid lines at 15-degree intervals.",
        tags=["reference", "geographic", "graticules", "world"],
    ),
    dict(
        layer="graticules_20",
        ...
        fields=None,
        name="Graticules 20°",
        full_name="Graticules 20°",
        description="Reference grid lines at 20-degree intervals.",
        tags=["reference", "geographic", "graticules", "world"],
    ),
    dict(
        layer="graticules_30",
        ...
        fields=None,
        name="Graticules 30°",
        full_name="Graticules 30°",
        description="Reference grid lines at 30-degree intervals.",
        tags=["reference", "geographic", "graticules", "world"],
    ),
]
            ...
            for scale in d["scales"]:
                ...
                try:
                    ...
                    results.append(DatasetMeta(
                        id=dataset_id,
                        name=d.get("full_name", f"{d['name']} ({scale})"),
